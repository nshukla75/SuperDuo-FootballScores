...
public class TodaysFixturesRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        setImageViewBitmapFromUrl(
                views,
                R.id.home_crest,
                data.getString(data.getColumnIndex(DatabaseContract.scores_table.HOME_LOGO_COL)));
        ...
        setImageViewBitmapFromUrl(
                views,
                R.id.away_crest,
                data.getString(data.getColumnIndex(DatabaseContract.scores_table.AWAY_LOGO_COL)));
        ...
        extras.putString(LatestFixtureWidgetProvider.SCORES_DATE,
                data.getString(data.getColumnIndex(DatabaseContract.scores_table.DATE_COL)));
        extras.putInt(TodaysFixturesWidgetProvider.SCORES_MATCH_ID,
                data.getInt(data.getColumnIndex(DatabaseContract.scores_table.MATCH_ID)));
    ...
    /**
     * Load an image from a url using glide into a bitmap and set it as the image of a remote imageview
